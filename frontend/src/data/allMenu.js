export const menu = [
  {
    name: "Campus",
    icon: "campus",
    description: "A unique, exclusive space for college students on Social.",
  },
  {
    name: "Events",
    icon: "events",
  ...
  },
  {
    name: "Pages",
    icon: "pages",
    description: "Discover and connect with businesses on Social.",
  },
  {
    name: "Watch",
    icon: "watch",
  ...
  },
  {
    ...
    icon: "recent",
    description: "See all the ads you interacted with on Social.",
  },
  {
    name: "Memories",
    icon: "memories",
    description: "Browse your old photos, videos and posts on Social.",
  },
  {
    name: "Saved",
    icon: "saved",
